...
export default function Page() {
  ...
  const tryFetch = useCallback(() => {
    multipleApiManager.fetch([
      { key: '1', axiosOptions: { method: 'get', url: 'https://cdn.pixabay.com/photo/2023/05/29/16/55/pie-8026562_640.jpg', responseType: 'blob' }, retryCount: 2, },
      ...
      { key: '4', axiosOptions: { method: 'get', url: 'https://cdn.pixabay.com/photo/2023/05/31/11/15/fish-8031138__340.jpg', responseType: 'blob' }, retryCount: 2, },
